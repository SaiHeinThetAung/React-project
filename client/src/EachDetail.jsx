  ...
  return (
    <div>
      <div className='flex flex-col mt-10 gap-4'>
        ...
        <div className='mx-auto w-[300px] shadow-lg p-4 mb-4'>
          <img className='w-[600px]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRO6gl8D3OzkpqmqJW5SlWLRbP2VhSEAZXUMg&usqp=CAU" alt="" />
